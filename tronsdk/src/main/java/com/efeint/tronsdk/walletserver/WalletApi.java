...
import com.efeint.tronsdk.api.GrpcAPI.Return;
...
import com.efeint.tronsdk.common.crypto.Hash;
import com.efeint.tronsdk.common.crypto.Sha256Hash;
import com.efeint.tronsdk.common.utils.Base58;
import com.efeint.tronsdk.common.utils.ByteArray;
import com.efeint.tronsdk.common.utils.TransactionUtils;
import com.efeint.tronsdk.common.utils.Utils;
import com.efeint.tronsdk.core.config.Parameter.CommonConstant;
import com.efeint.tronsdk.core.exception.CancelException;
import com.efeint.tronsdk.core.exception.CipherException;
import com.efeint.tronsdk.keystore.Credentials;
import com.efeint.tronsdk.keystore.Wallet;
import com.efeint.tronsdk.keystore.WalletFile;
import com.efeint.tronsdk.keystore.WalletUtils;
...
import com.efeint.tronsdk.protos.Contract.UpdateEnergyLimitContract;
import com.efeint.tronsdk.protos.Contract.UpdateSettingContract;
import com.efeint.tronsdk.protos.Protocol;
...
public class WalletApi {
  ...
  public Transaction signTransaction(Transaction transaction)
    ...
    byte[] passwd = com.efeint.tronsdk.keystore.StringUtils.char2Byte(password);
    com.efeint.tronsdk.keystore.StringUtils.clear(password);
    System.out.println(
    ...
    com.efeint.tronsdk.keystore.StringUtils.clear(passwd);
    return transaction;
  }
